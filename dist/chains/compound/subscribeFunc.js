    ...
    return __awaiter(this, void 0, void 0, function* () {
        for (let i = 0; i < 3; ++i) {
            try {
                ...
                log.error(`Compound ${governorAlphaAddress} at ${ethNetworkUrl} failure: ${err.message}`);
                yield sleep_promise_1.default(retryTimeMs);
                log.error('Retrying connection...');
            }
        }
        throw new Error(`Failed to start Compound listener for ${governorAlphaAddress} at ${ethNetworkUrl}`);
    });
}
