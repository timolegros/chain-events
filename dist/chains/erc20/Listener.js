...
class Listener extends Listener_1.Listener {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                this._api = yield subscribeFunc_1.createApi(this._options.url, this._options.tokenAddresses, 10000, this.options.tokenNames);
            }
            catch (error) {
    ...
    subscribe() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                log.info(`[${this._chain}]: Subscribing to the following token(s): ${this.options.tokenNames || '[token names not given!]'}, on url ${this._options.url}`);
