...
export declare type IChainEntityKind = SubstrateTypes.EntityKind | MolochTypes.EntityKind | CompoundTypes.EntityKind | AaveTypes.EntityKind;
export declare type IChainEventData = SubstrateTypes.IEventData | MolochTypes.IEventData | CompoundTypes.IEventData | AaveTypes.IEventData | Erc20Types.IEventData;
export declare type IChainEventKind = SubstrateTypes.EventKind | MolochTypes.EventKind | CompoundTypes.EventKind | AaveTypes.EventKind | Erc20Types.EventKind;
export declare const ChainEventKinds: (SubstrateTypes.EventKind | MolochTypes.EventKind | CompoundTypes.EventKind | AaveTypes.EventKind | Erc20Types.EventKind)[];
export declare const EventSupportingChains: readonly ["clover", "edgeware", "edgeware-local", "edgeware-testnet", "hydradx", "kusama", "kusama-local", "polkadot", "polkadot-local", "kulupu", "stafi", "moloch", "moloch-local", "compound", "marlin-local", "marlin", "uniswap", "aave", "aave-local", "dydx-ropsten", "dydx", "erc20"];
